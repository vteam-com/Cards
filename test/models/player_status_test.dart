...
void main() {
  group('PlayerStatus', () {
    ...
    test('fromJson creates PlayerStatus with empty strings when json is null',
        () {
    ...
    test('findMatchingPlayerStatusInstance', () {
      final PlayerStatus result1 =
          findMatchingPlayerStatusInstance('X', 'NOT REAL');
      // expecting to not find anything
      expect(result1.emoji, '');
      expect(result1.phrase, '');

      final PlayerStatus result =
          findMatchingPlayerStatusInstance('😙', 'Voila!');
      expect(result.emoji, '😙');
